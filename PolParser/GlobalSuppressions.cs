...
[assembly: SuppressMessage("Design", "CA1069:Enums values should not be duplicated", Justification = "Those values are the same by default accordin to the docs.", Scope = "type", Target = "~T:PolParser.RegType")]
